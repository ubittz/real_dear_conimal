...
class CustomDropDownMulti extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiSelectDropDown(
      ...
      hint: hintText,
      hintStyle: MyTextStyle.body16R.copyWith(
      ...
      chipConfig: ChipConfig(
        ...
        labelColor: MyColor.grayScale900,
        labelStyle: MyTextStyle.body16R,
        deleteIcon: PhosphorIcon(
          PhosphorIcons.x(),
          size: 20.0,
        ),
        deleteIconColor: MyColor.grayScale900,
        spacing: 4.0,
        runSpacing: 0.0,
      ),

      // 일반 상태
      optionTextStyle: MyTextStyle.body16R,
      optionsBackgroundColor: MyColor.empty,

      // 선택된 상태
      selectedOptionBackgroundColor: MyColor.grayScale300,
      ...
      // top
      borderRadius: 8.0,
      borderColor: MyColor.grayScale500,
      borderWidth: 1.0,
      clearIcon: null,
